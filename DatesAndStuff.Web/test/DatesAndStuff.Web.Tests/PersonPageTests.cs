...
public class PersonPageTests
{
    ...
    public void Person_SalaryIncrease_LessThanMinus10_ShouldShowValidationErrors()
    {
        ...
        var fieldValidation = wait.Until(ExpectedConditions.ElementExists(By.CssSelector(".col-md-10 .validation-message")));
        fieldValidation.Text.Should().Contain("The specified percentag should be between -10 and infinity.");
    }
